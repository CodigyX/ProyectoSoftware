...
import org.uv.venta.RegistroCliente;
/**
 *
 * @author meli
 */
public class TablaCliente extends javax.swing.JPanel {
    ...
    public TablaCliente() {
        initComponents();
         TextPrompt busqueda = new TextPrompt("Ingrese el nombre del cliente a buscar", txtBuscar);
    }
    ...
    private void txtBuscarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtBuscarMousePressed
        if(txtBuscar.getText().equals("Ingrese el nombre del cliente a buscar"))
        txtBuscar.setText("");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
         Dashboard.ShowJPanel(new RegistroCliente());
